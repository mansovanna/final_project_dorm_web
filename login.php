...
<body>
    <div class="wrapper">
        ...
        <form action="myloging_db.php" method="post">
            <h1>ប្រព័ន្ធគ្រប់គ្រងអន្តេវាសិកដ្ឋានសម្រាប់វិទ្យាស្ថានបច្ចេកវិទ្យាកំពង់ស្ពឺ</h1>

            <div class="input-container">
                <input type="text" placeholder="លេខសម្គាល់" name="student_id" required>
                <i class='bx bxs-user'></i>
                <?php if (isset($_SESSION['id_error'])): ?>
                    <div class="error-message"><?php echo $_SESSION['id_error']; unset($_SESSION['id_error']); ?></div>
                <?php endif; ?>
            </div>
            <div class="input-container">
