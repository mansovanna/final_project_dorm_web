...
<nav>
    <div class="content">
      <ul class="links">
            ...
            <li>
              <a href="#" style="text-decoration: none;">អំពីអន្តេ<i class='bx bxs-down-arrow'></i></a>
              <div class="sub-menu1">
                  <ul class="menu">
                      <li ><a href="staff.php">បុគ្គលិក</a></li>
            ...
            <div class="profile-box">
              <li><img src="../img/user1.png" class="profile-pic" onclick="toggleMenu()" ></li>
            </div>
        </ul>
    </div>
</nav>
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                <div class="col-md-6 col-lg-3">
                    <div class="team-member">
                        <img src='<?php echo $row['img']; ?>' alt='Staff Image' class="img-fluid" onclick="openModal('<?php echo $row['img']; ?>')">
